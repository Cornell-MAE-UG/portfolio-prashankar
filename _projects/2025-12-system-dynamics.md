...
image: \assets\images\mae3260_cover.jpg
---
...
The primary ODE that describes the control of the UAS is given by $J_z \ddot{\psi} = \tau_z + \tau_d$ where $\psi$ is the yaw angle and $\tau_z$ is the control torque. The power change to the motors is approximately given by $\Delta P = \frac{3}{8} \omega_h \tau_z$. The ideal feedback controller was a PD controller which retains the proportional correction and provides needed damping through the derivative term without further destabilizing the dynamics. The gain values were $K_P = 11$ and $K_D = 37$.   

[Download the full report]({{ "\assets\reports\2025-12-10-mae3260-final-report.pdf" | relative_url }}) in PDF format. 
